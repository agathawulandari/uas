            ...
            <form class="needs-validation" novalidate>
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="address" placeholder="masuk alamat anda" required>
                        <!-- <div class="invalid-feedback">
                            Masukan alamat anda
                        </div> -->
                    </div>
                ...
                <div class="container text-center">
                    <div class="row g-2">
                        ...
                        <div class="col-6">
                            <button class="w-100 btn btn-secondary btn-lg" type="submit">Batal</button>
                        </div>
                    </div>
