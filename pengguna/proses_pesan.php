...
if (isset($_POST["pesan_lapangan"])) {
    ...
    $id_pemesanan = 'PL' . str_pad($pemesanan_lapangan, 4, '0', STR_PAD_LEFT);
...
if (isset($_POST['bukti'])) {
    ...
    $query = "INSERT INTO pembayaran (id_pembayaran,id_pengguna, id_pemesanan, id_raket, metode_pembayaran, status_pembayaran, bukti_bayar, created_at) VALUES ('$id_pembayaran','$id_pengguna', '$id_pemesanan', '$id_raket', '$metode_pembayaran', '$status_pembayaran','$bukti_bayar_path', NOW())";
